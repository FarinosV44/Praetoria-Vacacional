...
| 2026-08-28 | #54 activate promo code 10PRAETORIA10 (10% off both properties): DB migration + DEMO seed via new `PRAETORIA10_COUPON` constant + forward-compat upsert. Committed to develop + merged to main. | claude-sonnet-5 | short session | 6 files, 1 commit; 61 unit + 65 chromium e2e green; issue #54 to be commented |
