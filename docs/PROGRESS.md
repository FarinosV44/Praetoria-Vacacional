...
| 56-F → 56-L | Calendar+pricing, marketing/segments/campaigns, promotions, Booking/Airbnb→internal, search/exports, roles/dashboard/logs, final E2E | ⬜ |

`tsc` + `next lint` + `next build` + 103 unit green after 56-E.
