...
| 56-G → 56-L | Marketing/segments/campaigns, promotions, Booking/Airbnb→internal, search/exports, roles/dashboard/logs, final E2E | ⬜ |

`tsc` + `next lint` + `next build` + 112 unit green after 56-F.
