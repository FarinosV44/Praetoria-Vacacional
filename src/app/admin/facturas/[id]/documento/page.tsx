...
export default async function InvoiceDocumentPage({
  ...
  const brandLabel =
    property?.name ??
    (experience === "ski" ? "Javalambre Mountain SuperSki" : "Valencia Frente al Mar");
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <p style={{ margin: "2px 0 0", color: "#666" }}>
              Fecha: {formatDateLong(invoice.issueDate)}
            </p>
            {voided && (
        ...
        <div style={{ display: "flex", gap: 32, marginTop: 28 }}>
          <div style={{ flex: 1 }}>
            <p style={{ margin: 0, fontSize: 11, textTransform: "uppercase", color: "#888" }}>
              Emisor
            </p>
        ...
        {invoice.taxNote && (
          <p style={{ marginTop: 24, fontSize: 12, color: "#444" }}>{invoice.taxNote}</p>
        )}
        {invoice.notes && (
          <p style={{ marginTop: 8, fontSize: 12, color: "#666", whiteSpace: "pre-wrap" }}>
            {invoice.notes}
          </p>
        )}
