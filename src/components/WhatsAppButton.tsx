...
export function WhatsAppButton({ number, locale }: { number?: string; locale: Locale }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 left-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[var(--shadow-lg)] transition-transform duration-[var(--dur-mid)] hover:scale-110 motion-reduce:hover:scale-100 sm:bottom-6"
    >
