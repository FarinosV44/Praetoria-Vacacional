...
export function WhatsAppButton({ number, locale }: { number?: string; locale: Locale }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 left-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[var(--shadow-card)] transition hover:scale-105 sm:bottom-6"
    >
